...
import org.compiere.minigrid.ColumnInfo; //JPIERE-0455
import org.compiere.model.MCurrency;     //JPIERE-0455
...
public class WListItemRenderer implements ListitemRenderer<Object>, EventListener<Event>, ListitemRendererExt
{
	...
	private void render(ListItem item, Object data, int index)
	{
		...
		setCurrency(table,rowIndex,data);//JPIERE-0455 InfoWindow Currency Fraction Control
	...
	/**
	 * JPIERE-0455 InfoWindow Currency Fractiion Control
	 */
	private MCurrency m_Currency = null;
	private int C_Currency_ColumnIndex = -1;
	...
	private void setCurrency(WListbox table,int rowIndex,Object data)
	{
		...
		if(m_Currency == null && Env.getContextAsInt(Env.getCtx(), "$C_Currency_ID") > 0)
			m_Currency = MCurrency.get(Env.getCtx(),Env.getContextAsInt(Env.getCtx(), "$C_Currency_ID"));
