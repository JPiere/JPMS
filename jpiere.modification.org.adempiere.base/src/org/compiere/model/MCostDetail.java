 ...
 * 	Cost Detail Model
 *	
 *  JPIERE-0620: Do not create Cost Detail
 *
 *  @author Jorg Janke
...
{	
		...
		String Description, Timestamp DateAcct, int Ref_CostDetail_ID, String trxName)
	{
		...
		//JPIERE-0620: Do not create Cost Detail
		if(!createCostDetail(as.getC_AcctSchema_ID(),M_Product_ID))
			return true;
	...
	public synchronized boolean process()
	{
		...
		//JPIERE-0620: Do not create Cost Detail
		if(!createCostDetail(getC_AcctSchema_ID(),getM_Product_ID()))
			return true;
	 ...
	 * @return
	 */
	public static boolean createCostDetail(int C_AcctSchema_ID, int M_Product_ID)
	{
		//	get costing level for product
