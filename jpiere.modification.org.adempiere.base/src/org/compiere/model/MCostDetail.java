...
public class MCostDetail extends X_M_CostDetail
{
	...
	{
		//JPIERE-0620: Do not create Cost Detail
		if(!createCostDitail(as.getC_AcctSchema_ID(),M_Product_ID))
			return true;
	...
	public synchronized boolean process()
	{
		...
		//JPIERE-0620: Do not create Cost Detail
		if(!createCostDitail(getC_AcctSchema_ID(),getM_Product_ID()))
			return true;
	 ...
	 * @return
	 */
	public static boolean createCostDitail(int C_AcctSchema_ID, int M_Product_ID)
	{
		//	get costing level for product
