...
//import org.apache.poi.ss.usermodel.BorderStyle;	//JPIERE-0463 would not like to import "org.apache.poi.ss.usermodel"
import org.compiere.model.MCurrency;				//JPIERE-0463
...
//			cs_header.setBorderLeft(BorderStyle.MEDIUM);	//JPIERE-0463 would not like to import "org.apache.poi.ss.usermodel"
//			cs_header.setBorderTop(BorderStyle.MEDIUM);		//JPIERE-0463 would not like to import "org.apache.poi.ss.usermodel"
//			cs_header.setBorderRight(BorderStyle.MEDIUM);	//JPIERE-0463 would not like to import "org.apache.poi.ss.usermodel"
//			cs_header.setBorderBottom(BorderStyle.MEDIUM);	//JPIERE-0463 would not like to import "org.apache.poi.ss.usermodel"
...
//		m_workbook.setRepeatingRowsAndColumns(m_sheetCount, 0, 0, 0, 0);
	...
	protected void formatPage(HSSFSheet sheet)
	{
		...
		ps.setNoColor(true);
//		ps.setPaperSize(HSSFPrintSetup.A4_PAPERSIZE); //JPIERE-0463 would not like to import "org.apache.poi.ss.usermodel"
